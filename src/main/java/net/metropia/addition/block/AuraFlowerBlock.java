...
public class AuraFlowerBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:aura_flower")
	public static final Block block = null;

	public AuraFlowerBlock(MetropiaadditionModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aura_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("metropiaaddition:aura_flower"), configuredFeature);
		}
	}
