...
public class IceAuraFlowerBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:ice_aura_flower")
	public static final Block block = null;

	public IceAuraFlowerBlock(MetropiaadditionModElements instance) {
		super(instance, 53);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ice_aura_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("metropiaaddition:ice_aura_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SLOWNESS, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("ice_aura_flower");
		}
