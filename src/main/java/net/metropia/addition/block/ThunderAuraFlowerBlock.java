...
public class ThunderAuraFlowerBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:thunder_aura_flower")
	public static final Block block = null;

	public ThunderAuraFlowerBlock(MetropiaadditionModElements instance) {
		super(instance, 55);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("thunder_aura_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("metropiaaddition:thunder_aura_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("thunder_aura_flower");
		}
