...
public class MagicVine2Block extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:magic_vine_2")
	public static final Block block = null;

	public MagicVine2Block(MetropiaadditionModElements instance) {
		super(instance, 41);
	}
