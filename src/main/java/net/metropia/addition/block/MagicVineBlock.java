...
public class MagicVineBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:magic_vine")
	public static final Block block = null;

	public MagicVineBlock(MetropiaadditionModElements instance) {
		super(instance, 38);
	}
