...
public class FaumortMushroomBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:faumort_mushroom")
	public static final Block block = null;

	public FaumortMushroomBlock(MetropiaadditionModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("faumort_mushroom");
		}
