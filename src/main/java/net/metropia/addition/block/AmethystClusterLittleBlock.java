...
public class AmethystClusterLittleBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:amethyst_cluster_little")
	public static final Block block = null;

	public AmethystClusterLittleBlock(MetropiaadditionModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_cluster_little");
		}
