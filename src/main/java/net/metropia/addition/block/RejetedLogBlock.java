...
public class RejetedLogBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:rejeted_log")
	public static final Block block = null;

	public RejetedLogBlock(MetropiaadditionModElements instance) {
		super(instance, 50);
	}
