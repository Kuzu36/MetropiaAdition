...
public class LittleAzaleaBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:little_azalea")
	public static final Block block = null;

	public LittleAzaleaBlock(MetropiaadditionModElements instance) {
		super(instance, 4);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("little_azalea"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("metropiaaddition:little_azalea"), configuredFeature);
		}
	}
