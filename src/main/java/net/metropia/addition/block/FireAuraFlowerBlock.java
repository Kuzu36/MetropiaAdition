...
import net.metropia.addition.procedures.FireAuraFlowerQuandLeMobjoueurEntreEnCollisionAvecLaPlanteProcedure;
...
public class FireAuraFlowerBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:fire_aura_flower")
	public static final Block block = null;

	public FireAuraFlowerBlock(MetropiaadditionModElements instance) {
		super(instance, 3);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("fire_aura_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("metropiaaddition:fire_aura_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("fire_aura_flower");
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			FireAuraFlowerQuandLeMobjoueurEntreEnCollisionAvecLaPlanteProcedure.executeProcedure(Stream
