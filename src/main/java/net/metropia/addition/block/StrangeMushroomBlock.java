...
public class StrangeMushroomBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:strange_mushroom")
	public static final Block block = null;

	public StrangeMushroomBlock(MetropiaadditionModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("strange_mushroom");
		}
