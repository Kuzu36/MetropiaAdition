...
public class AmethystClusterMidBlock extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:amethyst_cluster_mid")
	public static final Block block = null;

	public AmethystClusterMidBlock(MetropiaadditionModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_cluster_mid");
		}
