...
public class DepthMagicPowderItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:depth_magic_powder")
	public static final Item block = null;

	public DepthMagicPowderItem(MetropiaadditionModElements instance) {
		super(instance, 28);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("depth_magic_powder");
		}
