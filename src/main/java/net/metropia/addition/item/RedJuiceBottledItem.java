...
public class RedJuiceBottledItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:red_juice_bottled")
	public static final Item block = null;

	public RedJuiceBottledItem(MetropiaadditionModElements instance) {
		super(instance, 84);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(MetropiaHandcraftItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.5f)
							...
							.build()));
			setRegistryName("red_juice_bottled");
		}
