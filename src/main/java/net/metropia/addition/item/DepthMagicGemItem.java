...
public class DepthMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:depth_magic_gem")
	public static final Item block = null;

	public DepthMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("depth_magic_gem");
		}
