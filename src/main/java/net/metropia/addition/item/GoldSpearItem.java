...
public class GoldSpearItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:gold_spear")
	public static final Item block = null;

	public GoldSpearItem(MetropiaadditionModElements instance) {
		super(instance, 61);
	}
