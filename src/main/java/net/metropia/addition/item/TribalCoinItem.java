...
public class TribalCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:tribal_coin")
	public static final Item block = null;

	public TribalCoinItem(MetropiaadditionModElements instance) {
		super(instance, 68);
	}
