...
public class NeutralMagicFragmentItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:neutral_magic_fragment")
	public static final Item block = null;

	public NeutralMagicFragmentItem(MetropiaadditionModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("neutral_magic_fragment");
		}
