...
public class EarthMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:earth_magic_gem")
	public static final Item block = null;

	public EarthMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("earth_magic_gem");
		}
