...
public class GoldCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:gold_coin")
	public static final Item block = null;

	public GoldCoinItem(MetropiaadditionModElements instance) {
		super(instance, 17);
	}
