...
public class FireMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:fire_magic_gem")
	public static final Item block = null;

	public FireMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fire_magic_gem");
		}
