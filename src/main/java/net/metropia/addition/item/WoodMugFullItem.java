...
public class WoodMugFullItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:wood_mug_full")
	public static final Item block = null;

	public WoodMugFullItem(MetropiaadditionModElements instance) {
		super(instance, 76);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			ItemStack retval = new ItemStack(WoodMugItem.block);
