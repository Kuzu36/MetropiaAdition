...
public class GoldMugFullItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:gold_mug_full")
	public static final Item block = null;

	public GoldMugFullItem(MetropiaadditionModElements instance) {
		super(instance, 80);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			ItemStack retval = new ItemStack(GoldMugItem.block);
