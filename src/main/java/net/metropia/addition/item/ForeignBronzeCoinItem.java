...
public class ForeignBronzeCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:foreign_bronze_coin")
	public static final Item block = null;

	public ForeignBronzeCoinItem(MetropiaadditionModElements instance) {
		super(instance, 65);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("foreign_bronze_coin");
		}
