...
public class LightMagicPowderItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:light_magic_powder")
	public static final Item block = null;

	public LightMagicPowderItem(MetropiaadditionModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("light_magic_powder");
		}
