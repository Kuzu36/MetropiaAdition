...
public class NecromanticMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:necromantic_magic_gem")
	public static final Item block = null;

	public NecromanticMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 37);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("necromantic_magic_gem");
		}
