...
public class ForeignSilverCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:foreign_silver_coin")
	public static final Item block = null;

	public ForeignSilverCoinItem(MetropiaadditionModElements instance) {
		super(instance, 66);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("foreign_silver_coin");
		}
