...
public class KatanaItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:katana")
	public static final Item block = null;

	public KatanaItem(MetropiaadditionModElements instance) {
		super(instance, 64);
	}
