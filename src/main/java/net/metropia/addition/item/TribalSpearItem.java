...
public class TribalSpearItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:tribal_spear")
	public static final Item block = null;

	public TribalSpearItem(MetropiaadditionModElements instance) {
		super(instance, 63);
	}
