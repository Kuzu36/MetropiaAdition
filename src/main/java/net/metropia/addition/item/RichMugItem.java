...
public class RichMugItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:rich_mug")
	public static final Item block = null;

	public RichMugItem(MetropiaadditionModElements instance) {
		super(instance, 81);
	}
