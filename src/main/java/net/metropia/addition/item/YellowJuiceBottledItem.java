...
public class YellowJuiceBottledItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:yellow_juice_bottled")
	public static final Item block = null;

	public YellowJuiceBottledItem(MetropiaadditionModElements instance) {
		super(instance, 85);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MetropiaHandcraftItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.5f)
							...
							.build()));
			setRegistryName("yellow_juice_bottled");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			ItemStack retval = new ItemStack(GlassBottleItem.block);
