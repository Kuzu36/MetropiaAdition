...
public class DeepGoldCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:deep_gold_coin")
	public static final Item block = null;

	public DeepGoldCoinItem(MetropiaadditionModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("deep_gold_coin");
		}
