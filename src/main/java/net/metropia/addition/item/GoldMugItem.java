...
public class GoldMugItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:gold_mug")
	public static final Item block = null;

	public GoldMugItem(MetropiaadditionModElements instance) {
		super(instance, 79);
	}
