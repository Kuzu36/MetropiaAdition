...
public class PlatiniumCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:platinium_coin")
	public static final Item block = null;

	public PlatiniumCoinItem(MetropiaadditionModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("platinium_coin");
		}
