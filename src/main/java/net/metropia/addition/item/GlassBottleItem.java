...
public class GlassBottleItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:glass_bottle")
	public static final Item block = null;

	public GlassBottleItem(MetropiaadditionModElements instance) {
		super(instance, 83);
	}
