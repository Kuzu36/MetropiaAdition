...
public class RichMugFullItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:rich_mug_full")
	public static final Item block = null;

	public RichMugFullItem(MetropiaadditionModElements instance) {
		super(instance, 82);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			ItemStack retval = new ItemStack(RichMugItem.block);
