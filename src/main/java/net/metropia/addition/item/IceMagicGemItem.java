...
public class IceMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:ice_magic_gem")
	public static final Item block = null;

	public IceMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 34);
	}
