...
public class SilverCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:silver_coin")
	public static final Item block = null;

	public SilverCoinItem(MetropiaadditionModElements instance) {
		super(instance, 16);
	}
