...
public class ForeignGoldCoinItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:foreign_gold_coin")
	public static final Item block = null;

	public ForeignGoldCoinItem(MetropiaadditionModElements instance) {
		super(instance, 67);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("foreign_gold_coin");
		}
