...
public class MagicPowderItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:magic_powder")
	public static final Item block = null;

	public MagicPowderItem(MetropiaadditionModElements instance) {
		super(instance, 25);
	}
