...
public class LightMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:light_magic_gem")
	public static final Item block = null;

	public LightMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("light_magic_gem");
		}
