...
public class GuandaoSpearItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:guandao_spear")
	public static final Item block = null;

	public GuandaoSpearItem(MetropiaadditionModElements instance) {
		super(instance, 58);
	}
