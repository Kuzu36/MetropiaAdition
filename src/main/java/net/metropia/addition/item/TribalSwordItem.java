...
public class TribalSwordItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:tribal_sword")
	public static final Item block = null;

	public TribalSwordItem(MetropiaadditionModElements instance) {
		super(instance, 57);
	}
