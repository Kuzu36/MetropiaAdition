...
public class NeutralMagicGemItem extends MetropiaadditionModElements.ModElement {
	@ObjectHolder("metropiaaddition:neutral_magic_gem")
	public static final Item block = null;

	public NeutralMagicGemItem(MetropiaadditionModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("neutral_magic_gem");
		}
